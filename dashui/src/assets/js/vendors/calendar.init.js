...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        eventClick: function (info) {
            ...
            var eventDescription = selectedEvent.extendedProps.description === undefined ? "Sin Descripción" : selectedEvent.extendedProps.description;
            var eventLocation = selectedEvent.extendedProps.location === undefined ? "Sin Localización" : selectedEvent.extendedProps.location;
