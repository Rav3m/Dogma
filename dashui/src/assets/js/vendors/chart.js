...
(function () {
  ...
  if ($("#perfomanceChart").length) {
	...
	window.chart = new ApexCharts(document.querySelector("#perfomanceChart"), options);
	window.chart.render();
  ...
  if ($('#budgetExpenseChart').length) {
	...
	window.budgetExpenseChart = new ApexCharts(document.querySelector("#budgetExpenseChart"), options);
	window.budgetExpenseChart.render();
	console.log("Gráfico de radar inicializado", window.budgetExpenseChart);
  }
